...
public class StaffController {
    ...
    private void listStaffs() {
        ...
        for (Staff stf : Staffs) {
            Object[] row = { stf.getId(), stf.getNom(), stf.getPrenom(), stf.getEmail(), stf.getPhone(),
                    stf.getSalaire(), stf.getRole(), stf.getPoste() };
            model.addRow(row);
        }
    ...
    private void modifyStaff() {
        try {
            ...
            int confirmation = JOptionPane.showConfirmDialog(view, "Confirmez-vous la modification ?", "Confirmation",
